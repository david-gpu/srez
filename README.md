...
Here's an random, non cherry-picked, example of what this network can do. From left to right, the first column is the 16x16 input image, the second column is what you would get from a standard bicubic interpolation, the third column is the output generated by the neural net, and the rightmost column is the ground truth.
